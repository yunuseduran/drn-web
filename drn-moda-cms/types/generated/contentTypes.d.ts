...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    JobsType: Schema.Attribute.Enumeration<
      ['Tasar\u0131m', '\u00DCretim', 'Kalite', 'D\u0131\u015F Ticaret']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00DCretim'>;
    Konum: Schema.Attribute.Enumeration<
      [
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    Pozisyon: Schema.Attribute.String & Schema.Attribute.Required;
    PozisyonSekli: Schema.Attribute.Enumeration<
      ['Tam Zamanl\u0131', 'Yar\u0131 Zamanl\u0131', 'Stajyer']
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
