    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Servisler */}
          <div className="col-span-1">
            <h3 className="text-lg font-bold mb-6">Servislerimiz</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/ne-yapiyoruz/moda-tasarim" className="text-gray-400 hover:text-white transition-colors">Moda & Tasarım</Link>
              </li>
              <li>
                <Link href="/ne-yapiyoruz/is-gelistirme-tedarik" className="text-gray-400 hover:text-white transition-colors">İş Geliştirme & Tedarik</Link>
              </li>
              <li>
                <Link href="/ne-yapiyoruz/uretim-sevkiyat" className="text-gray-400 hover:text-white transition-colors">Üretim & Sevkiyat</Link>
              </li>
              <li>
                <Link href="/ne-yapiyoruz/baski-nakis" className="text-gray-400 hover:text-white transition-colors">Baskı & Nakış</Link>
              </li>
              <li>
                <Link href="/ne-yapiyoruz/fitness-spor" className="text-gray-400 hover:text-white transition-colors">Fitness & Spor</Link>
              </li>
              <li>
                <Link href="/ne-yapiyoruz/gunluk-giyim" className="text-gray-400 hover:text-white transition-colors">Günlük Giyim</Link>
              </li>
            </ul>
          </div>
